...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./components/listable.js": 2,
		"./main/main.js": 5,
		"./models/Groceries.js": 7,
		"./models/Grocery.js": 6
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var list = function Listable(listName, item, attr) {
	  return _vue2.default.component(listName, {
	    props: [item],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _listable = __webpack_require__(2);
	...
	var _Groceries = __webpack_require__(7);

	var _Groceries2 = _interopRequireDefault(_Groceries);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var list = new _listable2.default('todo-item', 'todo', 'getText()');
	var groceries = new _Groceries2.default();

	groceries.addGrocery(new _Grocery2.default('Vegetables'));
...
/***/ function(module, exports) {
	...
	var Grocery = function () {
	  function Grocery(text, attributes) {
...
/***/ function(module, exports) {
	...
	var Groceries = function () {
	  ...
	  _createClass(Groceries, [{
	    key: "addGrocery",
	    value: function addGrocery(grocery) {
	      return this.groceries.push(grocery);
	    }
	  }, {
	    key: "getGroceries",
	    value: function getGroceries() {
